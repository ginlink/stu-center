  ...
  <view class="vacation-item">
    <view v-if="vacation" class="item">
      <view class="" style="flex: 1; display: flex; flex-direction: column">
        <view class="" style="font-size: 34rpx"> 我的 {{ vacation.detail.type | showType }}申请 </view>
        <view class="" style="font-size: 28rpx; color: #9b9b9b">
          {{ time }}
        </view>
      ...
      <view class="" style="flex: 0.2">
        <view class="" style="position: absolute; top: 5px; color: #9b9b9b">
