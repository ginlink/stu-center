			...
			<u-form :model="form" ref="uForm">
				<view v-show="currentIndex==1" class="form-wrapper">
					...
					<u-form-item label-position="top" :label-width="labelWidth" label="请假原因" prop="reason">
						<u-input v-model="form.reason" type="textarea" :height="textareaHeight" placeholder="样例假条，请修改您想修改的地方" auto-height />
					</u-form-item>
					...
					<u-form-item :label-width="labelWidth" label="选择假条状态" prop="statusLabel" :border-bottom="false">
						<u-input v-model="form.statusLabel" type="select" placeholder="请选择" @click="isPassSelect=!isPassSelect" />
					</u-form-item>
				</view>
